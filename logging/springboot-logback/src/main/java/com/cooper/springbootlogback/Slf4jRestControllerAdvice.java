package com.cooper.springbootlogback;

import com.cooper.springbootlogback.common.CommonException;
...
public class Slf4jRestControllerAdvice {
    ...
    private final Logger logger = LoggerFactory.getLogger(Slf4jRestControllerAdvice.class);
