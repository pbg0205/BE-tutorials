...
@EnableJpaRepositories(basePackages = "com.cooper.hibernatemultitenancy.repository.tenant",
...
public class TenantConfig {
    ...
    public LocalContainerEntityManagerFactoryBean tenantEntityManagerFactory() {
        ...
        entityManagerFactoryBean.setPackagesToScan("com.cooper.hibernatemultitenancy.domain.tenant");
